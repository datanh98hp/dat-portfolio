...
const content = [
  {
    title: "Granduated Vietnam Maritime Vimaru University",
    description:
    ...
    content: (
      <div className="h-full w-full bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] flex items-center justify-center text-white text-center">
        Granduated Vietnam Maritime Vimaru University
      </div>
    ),
  },
  {
    title: "Work at HPK company",
    description:
  ...
  {
    title: "Work at LG Display company",
    description:
      "Experience real-time updates and never stress about version control again. Our platform ensures that you're always working on the most recent version of your project, eliminating the need for constant manual updates. Stay in the loop, keep your team aligned, and maintain the flow of your work without any interruptions.",
    content: (
      <div className="h-full w-full bg-[linear-gradient(to_bottom_right,var(--orange-500),var(--yellow-500))] flex items-center justify-center text-white">
        Working with Internal warehouse
      </div>
    ),
  },
  {
    title: "Working at UWAL Company",
    description:
      "Making website from requirements of customers. Managing version and analystic requirements to pre-handle the project.",
    content: (
...
export function StickyScrollRevealContainer() {
  return (
